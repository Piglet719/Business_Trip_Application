...
<html lang="en">
    ...
    <body>
        ...
        <section class="bg-insert">
            <div id="contents">
                <form name="form" action="insert.php" method="POST" accept-charset="UTF-8" align="center">
...
if(isset($_POST['submit'])){
	...
	if(!sqlsrv_query($conn,$sql)){
        echo "<script>alert('Error input!'); location.href = 'insert.php';</script>";
	}
	else{
		echo "<script>alert('Insert successfully!'); location.href = 'insert.php';</script>";
	}
}
